...
. Wählen Sie im VMware-Menü *Bewerten und planen* und anschließend *Migration zu VMware Cloud on AWS*.
+
Die Hauptseite des VMware Migration Advisor wird angezeigt.

. Wählen Sie *VMC planen und erstellen*.
. Wählen Sie *Los geht's!*. Sie können die Anzeige dieser Seite durch Aktivieren des Kontrollkästchens deaktivieren.
...
.Schritte
. Laden Sie RVTools 4.4.2 oder höher herunter und installieren Sie es im https://www.dell.com/en-us/shop/vmware/sl/rvtools["RVTools-Website"^]
...
+
Siehe das Kapitel über „Befehlszeilenparameter“ im https://www.dell.com/en-us/shop/vmware/sl/rvtools["Die RVTools-Dokumentation finden Sie im Abschnitt „Ressourcen“."^] für weitere Details.
