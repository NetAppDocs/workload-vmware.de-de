...
---
= Erfassung Ihrer aktuellen VM-Konfigurationen
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
. Wählen Sie in der VMware-Kachel *Plan and Deploy* aus.
+
image:screenshot-choose-method.png["Ein Screenshot mit den verschiedenen Methoden zum Sammeln Ihrer aktuellen VM-Konfigurationsinformationen"]
...
+
Weitere Informationen finden Sie im Kapitel „Kommandozeilenparameter“ in der https://resources.robware.net/resources/prod/RVTools.pdf["RVTools-Dokumentation"^] .
...
link:launch-onboarding-advisor.html["Erstellen eines Implementierungsplans mithilfe des Migrationsberaters"].
