...
https://www.dell.com/en-us/shop/vmware/sl/rvtools["Erfahren Sie mehr über RVTools"^]

.Schritte
. Laden Sie RVTools 4.4.2 oder höher herunter und installieren Sie es von https://www.dell.com/en-us/shop/vmware/sl/rvtools["RVTools-Website"^]
...
+
Siehe das Kapitel über „Befehlszeilenparameter“ im https://www.dell.com/en-us/shop/vmware/sl/rvtools["RVTools-Dokumentation"^] für weitere Details.
...
+
Das Planungszentrum wird angezeigt. Im Planungszentrum können Sie Ihre VM-Inventardaten hochladen, frühere Uploads einsehen und eine Migration mithilfe beliebiger VM-Inventardatensätze planen. Wählen Sie anschließend *Migration zu AWS Native Compute* aus. Der VMware Migration Advisor-Startbildschirm wird angezeigt.
...
. Speichern Sie dieses Token zur Vorbereitung der Verwendung mit dem Workload Factory-Migrationsberater.
