...
+
Vom Planungscenter aus können Sie Ihre VM-Inventardaten hochladen, vorherige Inventardaten-Uploads anzeigen und eine Migration mit einem beliebigen VM-Inventardatensatz planen. Wählen Sie dann *Migration zu AWS Native Compute* aus.  Der Begrüßungsbildschirm des VMware-Migrationsberaters wird angezeigt.
